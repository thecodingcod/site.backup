...
- When some bug got introduced
- or who created a piece of code

It should all be ready for the take when looking at the revision history.
...
### The Special Type of a Bad Commit Messages 
> A Commit messages that take 3 minutes to read.
...
> ❕  If they cannot be related to each other by any means. Then, it means a new commit is needed!
...
For example, JIRA Ticket Number would provide anyone with:
...
- investigate, change, run, debug, rollback, investigate again, run, debug, … it’s the mid of night already! 
