...
If you're one of the above, then here is the magic solution that would enable you to create a **FAKE API**, don't worry it's not totally Fake because it can handle all the CRUD operations that you'd require, along with filtering, sorting, routing and more. feel free to explore their repo mentioned below.
...
1. Create a file (anywhere) and call it `db.json` just for a matter of convention.
...
1. Describe your API, for example:
